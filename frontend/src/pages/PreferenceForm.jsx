...
export default function PreferenceForm() {
    ...
    useEffect(() => {
        // Make an HTTP request to fetch the card image from the backend
        axios.get('/api/projects/preference')
        .then((response) => {
            // Assuming the response contains the image URL
            console.log(response.data);
    ...
    const handleSubmit = (e) => {
        ...
        if (data1.project === '' || data1.sop === '' || data2.project === '' || data2.sop === '' ||data3.project === '' || data3.sop === '') {
            ...
            axios.post('api/projects/preference/', formData1)
                .then(res => {
                    console.log(res)
                })
                .catch(err => {
                ...
                axios.post('api/projects/preference/', formData2)
                .then(res => {
                    console.log(res)
                })
                .catch(err => {
                ...
                axios.post('api/projects/preference/', formData3)
                .then(res => {
                    console.log(res);
                    setSubmitted(true);
                })
